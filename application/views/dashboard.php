                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                            <a class="nav-link icon text-center country-nav-link" data-bs-target="#country-selector" data-bs-toggle="modal">
												<img class="header-icons language" alt="" src="<?php echo base_url('assets/images/flags/us_flag.jpg') ?>">
											</a>
                                        </div>
                                        <!-- SEARCH -->
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                                    <a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/ecommerce/1.jpg') ?>"></span>
													...
													<a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/ecommerce/2.jpg') ?>"></span>
                                                        <div class="wp-60 cart-desc mt-1">
													...
													<a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/ecommerce/3.jpg') ?>"></span>
                                                        <div class="wp-60 cart-desc mt-1">
													...
													<a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/ecommerce/4.jpg') ?>"></span>
                                                        <div class="wp-60 cart-desc mt-1">
													...
													<a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/ecommerce/5.jpg') ?>"></span>
                                                        <div class="wp-60 cart-desc mt-1">
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
												...
												<div class="message-menu ps2 overflow-hidden">
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/1.jpg') ?>" style="background: url(&quot;../assets/images/users/1.jpg&quot;) center center;"></span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/15.jpg') ?>" style="background: url(&quot;../assets/images/users/15.jpg&quot;) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/12.jpg') ?>" style="background: url(&quot;../assets/images/users/12.jpg&quot;) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/4.jpg') ?>" style="background: url(&quot;../assets/images/users/4.jpg&quot;) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
										...
										<div class="dropdown d-md-flex profile-1">
											<a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
													<img src="<?php echo base_url('assets/images/faces/6.jpg') ?>" alt="profile-user"
														class="avatar  profile-user brround cover-image">
												</span>
												<div class="text-center p-1 d-flex d-lg-none-max">
													<h6 class="mb-0" id="profile-heading"><?php echo ucfirst($this->session->userdata('fullname')); ?><i class="user-angle ms-1 fa fa-angle-down "></i></h6>
												</div>
											</a>
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
							...
							<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold"><?php echo $order_count; ?></h3>
						...
						<div class="row">
							...
							<div class="col-md-12 d-flex mb-4">
								...
								<div class="m-0 wp-70 text-dark d-flex align-items-center">
									<div class="me-2">
										<img alt="User Avatar" class="rounded-circle avatar-sm" src="<?php echo base_url('assets/images/users/7.jpg') ?>">
									</div>
									<div>
										...
										<tbody>
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-md" src="<?php echo base_url('assets/images/users/8.jpg') ?>">
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-md" src="<?php echo base_url('assets/images/users/2.jpg') ?>">
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-md" src="<?php echo base_url('assets/images/users/11.jpg') ?>">
														</div>
														<div>
											...
											<tr class="row-last">
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-lg" src="<?php echo base_url('assets/images/users/14.jpg') ?>">
														</div>
														<div>
								...
								<div class="row">
									<div class="mt-5">
										<div class="media mb-5 overflow-visible">
											<div class="me-3">
												<a href="profile.html"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="<?php echo base_url('assets/images/users/5.jpg') ?>"> </a>
											</div>
											<div class="media-body overflow-visible">
												...
												<div class="media mb-5 overflow-visible">
													<div class="me-3">
														<a href="profile.html"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="<?php echo base_url('assets/images/users/2.jpg') ?>"> </a>
													</div>
                        ...
                        <ul class="row row-sm p-3">
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="unitedstates" src="<?php echo base_url('assets/images/flags/us_flag.jpg') ?>" class="me-2 language"></span>United States
                                </a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="italy" src="<?php echo base_url('assets/images/flags/italy_flag.jpg') ?>" class="me-2 language"></span>Italy
                                </a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="spain" src="<?php echo base_url('assets/images/flags/spain_flag.jpg') ?>" class="me-2 language"></span>Spain
								</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
								    <span class="country-selector"><img alt="india" src="<?php echo base_url('assets/images/flags/india_flag.jpg') ?>" class="me-2 language"></span>India
                               </a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
								    <span class="country-selector"><img alt="french" src="<?php echo base_url('assets/images/flags/french_flag.jpg') ?>" class="me-2 language"></span>French
                                </a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="russia" src="<?php echo base_url('assets/images/flags/russia_flag.jpg') ?>" class="me-2 language"></span>Russia
								</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
								    <span class="country-selector"><img alt="germany" src="<?php echo base_url('assets/images/flags/germany_flag.jpg') ?>" class="me-2 language"></span>Germany
                               	</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="argentina" src="<?php echo base_url('assets/images/flags/argentina_flag.jpg') ?>" class="me-2 language"></span>Argentina
								</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
								    <span class="country-selector"><img alt="uae" src="<?php echo base_url('assets/images/flags/uae_flag.jpg') ?>" class="me-2 language"></span>UAE
                               	</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="austria" src="<?php echo base_url('assets/images/flags/austria_flag.jpg') ?>" class="me-2 language"></span>Austria
								</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="mexico" src="<?php echo base_url('assets/images/flags/mexico_flag.jpg') ?>" class="me-2 language"></span>Mexico
								</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
								    <span class="country-selector"><img alt="china" src="<?php echo base_url('assets/images/flags/china_flag.jpg') ?>" class="me-2 language"></span>China
                               </a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="poland" src="<?php echo base_url('assets/images/flags/poland_flag.jpg') ?>" class="me-2 language"></span>Poland
                                </a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="canada" src="<?php echo base_url('assets/images/flags/canada_flag.jpg') ?>" class="me-2 language"></span>Canada
								</a>
							</li>
							<li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
									<span class="country-selector"><img alt="malaysia" src="<?php echo base_url('assets/images/flags/malaysia_flag.jpg') ?>" class="me-2 language"></span>Malaysia
                                </a>
							</li>
						</ul>
                    </div>
